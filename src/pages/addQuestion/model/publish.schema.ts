...
export const publishSchema = z
  .object({
    ...
    expiry_date: z.any().nullable(),
  })
  .refine((data) => data.publishMode !== 'schedule' || !!data.scheduled_date, {
    path: ['scheduled_date'],
    message: 'Schedule date is required',
  })
  .refine((data) => data.liveUntil !== 'custom' || !!data.expiry_date, {
    path: ['expiry_date'],
